                        ...
                        <div className="header--standard-wrap">
                            <a href="#" className="logo">
                                <div className="img-wrap">
                                    <img width={200} src={logo} alt="Olympus"></img>
                                </div>
                            </a>
                        </div>
                    </div>
                        ...
                        <div className="col col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                            <div className="landing-content">
                                ...
                                <p>We are the best and biggest social network with 5 billion active users all around the
                                    world. Share you
                                    thoughts, write blog posts, show your favourite music via Stopify, earn badges and
                                    much more!
                                </p>
                                        ...
                                        <div className="row">
                                            <div className="col col-12 col-xl-12 col-lg-12 col-md-12 col-sm-12">
                                                <div className="form-group label-floating is-empty">
                                                    ...
                                                    <input className="form-control" placeholder="" type="email" name="email"/>
                                                </div>
                                                <div className="form-group label-floating is-empty">
                                                    <label className="control-label" htmlFor="pwd">Your Password</label>
                                                    <input className="form-control" placeholder="" type="password" name="pwd"/>
                                                </div>
